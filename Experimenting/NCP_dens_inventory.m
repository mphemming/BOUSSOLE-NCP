...
O2_inv.inv_integral = [means_struct.O2_h].*[means_struct.depth_of_isopycnal];
O2_inv.differentials = diff([means_struct.O2_h].*[means_struct.depth_of_isopycnal]); % mean concentration x depth of layer
...
O2_inv.inv_std = diff([means_struct.O2_std_h].*[means_struct.depth_of_isopycnal]); % mean concentration x depth of layer
