...
% modified by MPH in Sydney, 22/05/2019
...
for day = options.dayrange-8
    ...
    % calc mean for h 
    %------------------------------------------------------------------------------------------------
    O2_adv(day).DU_abs_h =means_struct(day).GVsat_U; % using AVISO velocities instead!
    O2_adv(day).DV_abs_h =means_struct(day).GVsat_V;    
    %------------------------------------------------------------------------------------------------    
