...
ADV = [O2_adv.adv];
y = [O2_inv.inv(2:end-1), ADV(2:end-1)', O2_ase.ASE(2:end-1)', ([O2_ent.ent])'.*-1, kz_(2:end-1)'];
...
l = legend('^{\partial I}/_{\partial t}','\itF_{\rmADV}','\itF_{\rmASE}','\itF_{\rmENT}','\itF_{\rmV}','Location','NorthWest','Orientation','horizontal');
...
hold on;
ADV = [DIC_adv.adv];
y = [DIC_inv.inv(2:16), ADV(2:16)', DIC_ase.FDIC(2:16)', ([DIC_ent([1:16]).ent])'.*-1, kz_(2:16)'];
...
set(gca,'XTick',[1:3:25],'XTickLabels',[{'10'} {'13'} {'16'} {'19'} {'22'} {'25'} {'28'} {'31'} {'3'}],...
    'YTick',[-600 -500 -400 -300 -200 -100 0 100],'XGrid','On')
